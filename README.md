...
Étudiante en 3ème année de Bachelor **Administration Systèmes, Réseaux et Sécurité** à l'IPSSI, je suis actuellement à la recherche de deux opportunités pour valider mon cursus et poursuivre mon parcours :

1. 🎯 Un **stage** pour clore mon année de Bachelor.
2. 🚀 Une **alternance** dans le cadre de mon **Mastère Expert Cyber** (Rentrée 2026).

📅 **Mon rythme d'alternance :** 1 semaine en école / 3 semaines en entreprise.

Passionnée par le durcissement des systèmes, l'architecture réseau et la sécurité opérationnelle, je documente ici mes projets académiques et personnels afin de d'exposer mes compétences pratiques.
...
* ![Topologie réseau Cisco Packet Tracer](./Topologie.png)

---

## 📬 Me contacter

* 📧 **Email :** [tiphaniennonnang@gmail.com](mailto:tiphaniennonnang@gmail.com)
* 💼 **LinkedIn :** [Tiphanie N'NO](https://www.linkedin.com/in/tiphanie-n%E2%80%99no-7445562aa)
* 📍 **Localisation :** Île-de-France (Boussy-Saint-Antoine, 91)
